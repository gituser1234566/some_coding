...
def parse_arguments():
    ...
    parser.add_argument('--model', type=str, default='/fp/projects01/ec30/models/xlm-roberta-base/', help='The model to use /fp/projects01/ec30/models/bert-base-multilingual-cased,  /fp/projects01/ec30/models/distiluse-base-multilingual-cased-v1 or /fp/projects01/ec30/models/xlm-roberta-base/ ')
...
# for each case and save the best model
    ...
    for i in range(len(train_key)):
        ...
        #do the same for test
            ...
            path= f"plots/f1xlm/f1{train_key[i],test_key[j]}"
            path2= f"plots/loss_xlm/Loss{train_key[i],test_key[j]}"
        ...
        if  f1_avg< average_f1:
          ...
          #move to cpu for save
            ...
            save_model_named="ner_model_XML"
