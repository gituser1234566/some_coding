...
def parse_arguments():
    ...
    parser.add_argument('--model', type=str, default='/fp/projects01/ec30/models/distiluse-base-multilingual-cased-v1', help='The model to use /fp/projects01/ec30/models/bert-base-multilingual-cased,  /fp/projects01/ec30/models/distiluse-base-multilingual-cased-v1 or /fp/projects01/ec30/models/xlm-roberta-base/ ')
...
def main():
    ...
    for i in range(len(train_key)):
        ...
        for j in range(len(test_key)):
            ...
            path= f"plots/f1distiluse/f1{train_key[i],test_key[j]}"
            path2= f"plots/loss_distiluse/Loss{train_key[i],test_key[j]}"
        ...
        if  f1_avg< average_f1:
            ...
            save_model_named="ner_model_Distiluse"
